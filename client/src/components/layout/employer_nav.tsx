...
const erNavbar: React.FC = () => {
    ...
    <nav className="bg-slate-500">
        <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div className="flex space-x-3">
                    ...
                    <a href="#" className="rounded-md px-3 py-2 text-sm font-medium text-yellow-50 hover:bg-slate-700 hover:text-white">Employees</a>
                    <a href="#" className="rounded-md px-3 py-2 text-sm font-medium text-yellow-50 hover:bg-slate-700 hover:text-white">Jobs</a>
                </div>
                </div>
            </div>
        ...
        <div className="sm:hidden" id="mobile-menu">
            ...
            <a href="#" className="block rounded-md px-3 py-2 text-base font-medium text-yellow-50 hover:bg-slate-700 hover:text-white">Employees</a>
            <a href="#" className="block rounded-md px-3 py-2 text-base font-medium text-yellow-50 hover:bg-slate-700 hover:text-white">Jobs</a>
            </div>
        </div>
        </nav>
    );
